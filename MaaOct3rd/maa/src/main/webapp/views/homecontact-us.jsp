...
<head>
 ...
 <title>Contact Us &ndash; Know How to Reach | maaproperties.com</title>
  <link href="resources/images/favicon.ico" rel="shortcut icon">
  <meta name="keywords" content="Contact Us &ndash; Property Portal in Hyderabad ,real estate in hyderabad,real estate in Vijaywada,real estate in Vizag,real estate in Bangalore, maaproperties.com">
  <meta name="description" content="Contact Us &ndash; Get complete details of office locations and addresses online.">
  <link rel="canonical" href="http://maaproperties.com/contactus">
<!---Facebook--->
    <meta property="og:site_name" content="maaproperties.com"/>
    <meta property="og:url" content="http://maaproperties.com/contactus"/>
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Contact Us &ndash; Know How to Reach | maaproperties.com"/>
    <meta property="og:image" content="http://maaproperties.com/resources/homeimages/home-img/whatsapp.png"/>
    <meta property="og:description" content="Contact Us &ndash; Get complete details of office locations and addresses online." />
...
<!---twitter card --->
    ...
    <meta name="twitter:title" content="Contact Us &ndash; Know How to Reach | maaproperties.com">
    <meta name="twitter:description" content="Contact Us &ndash; Get complete details of office locations and addresses online.">
    <meta name="twitter:image" content="http://maaproperties.com/resources/homeimages/home-img/whatsapp.png">
<!-- Bootstrap CSS -->
						...
						<div class="address-desc-box">
							...
							<div class="social-media my-3">
								<span class="facebook-icon mr-3">
									<a href="https://www.facebook.com/maaproperties/">
										<i class="fab fa-facebook-square"></i>
									</a>
								</span>
								<span class="twitter-icon mr-3">
									<a href="https://twitter.com/maaproperties">
										<i class="fab fa-twitter-square"></i>
									</a>
								</span>

								<span class="youtube-icon mr-3">
									<a href="https://www.youtube.com/channel/UCAMCuKB1COcICj0tP-l6fmg"><i class="fab fa-youtube"></i></a>
								</span>
								<span class="pinterest mr-3">
									<a href="https://www.pinterest.com/maaproperties12/"><i class="fab fa-pinterest"></i></a>
								</span>
							</div>
						<p>For any suggestions, please mail us at <a href="#">info@maaproperties.com</a></p>
					</div>
				</div>
				<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
					<div class="add-image">
						<img src="resources/homeimages/banner/add1.jpg" class="img-fluid">
					</div>
				</div>
			</div>
		</div>
						...
						<div class="row no-gutters mt-3">
							<div class="col-3">
								<div class="image_property mr-2">
									<img src="resources/homeimages/logo/maa_logo-29.png" class="img-fluid">
								</div>
							</div>
							<div class="col-9">
