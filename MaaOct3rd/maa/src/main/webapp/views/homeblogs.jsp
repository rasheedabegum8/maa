...
<head>
    ...
    <title>Real Estate Articles for  Buy/Sell/Rental Properties| Maaproperties.com</title>
    <meta name="description" content="Maaproperties provides Latest Property Insights, News, Events, Opinions and property trends in Hyderabad. Experts guide to Indian Real Estate market">
   <meta name="keywords" content="Latest Real Estate News, Property articles, Real Estate articles,  Property Leagal articles,home interior designs,Real Estate Blogs">
   <link herf="http://maaproperties.com/blog" rel="canonical">
    <meta property="og:site_name" content="maaproperties.com"/>
    <meta property="og:url" content="http://maaproperties.com/blog"/>
    <meta property="og:type" content="website"/>
    <meta property="og:title" content="Real Estate Articles for  Buy/Sell/Rental Properties| Maaproperties.com"/>
    <meta property="og:image" content="http://maaproperties.com/resources/homeimages/testimonials/ramakrishna.jpg"/>
    <meta property="og:description" content="Maaproperties provides Latest Property Insights, News, Events, Opinions and property trends in Hyderabad. Experts guide to Indian Real Estate market"/>
    ...
    <meta name="twitter:title" content="Real Estate Articles for  Buy/Sell/Rental Properties| Maaproperties.com">
    <meta name="twitter:description" content="Maaproperties provides Latest Property Insights, News, Events, Opinions and property trends in Hyderabad. Experts guide to Indian Real Estate market.">
    <meta name="twitter:image" content="http://maaproperties.com/resources/homeimages/testimonials/ramakrishna.jpg">	
...
<body>
	...
	<section id="bread">
	 ...
	 <section id="classified" class="mt-5">
		<div class="container">
			<div class="common-title my-5">
				<h3>Blog</h3>
			</div>
						...
						<div class="blogs-img">
						 ...
						 <c:choose>
                                    <c:when test="${not empty blog.image}">
                                         <a href="blog-info?blog=${blog.blogid}"><img src="resources/blogimages/${blog.image}" class="img-fluid"></a>   
                                                                     </c:when> 
                                       <c:otherwise> 
                                       <a href="blogs-info?blog=${blog.blogid}"><img src="resources/images/home-images/3.jpg" class="img-fluid"></a>
                                 </c:otherwise>      </c:choose>
							
						</div>
						
						<div class="hash-tags">
							<span><a href="#">${blog.tags}</a></span>
							
						</div>
						<a href="blog-info?blog=${blog.blogid}"><div class="blogs-head p-3 pl-3 pr-2">
							<h5>${blog.title}</h5>
			...
			<div class="row my-5">
				<div class="col text-center">
					<button type="button" class="btn mt-2" id="custm-innerbtn">Load More</button>
				</div>
			</div>
		</div>
	</section> 
