		...
		<nav class="navbar navbar-expand-sm navbar-default">
			<div id="main-menu" class="main-menu collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<li class="active">
						<a href="Masteradminsscreen-dashboard.html"><i class="menu-icon fa fa-laptop"></i>Dashboard </a>
					</li>
					<li>
						<a href="#"><i class="menu-icon fa fa-building-o"></i>Property list </a>
					</li>
					<li>
						<a href="classifides-admin.html"><i class="menu-icon fa fa-cubes"></i>Classifieds </a>
					</li>
					<li>
						<a href="vendor-details.html"><i class="menu-icon fa fa-user"></i>Vendors </a>
					</li>
					<li>
						<a href="no%20of%20vaicancy.html"><i class="menu-icon fa fa-search"></i>No of vacancies</a>
					</li>
					<li>
						<a href="reports.html"><i class="menu-icon fa fa-file" aria-hidden="true"></i>Reports</a>
					</li>
					<li>
						<a href="blogs.html"><i class="fa fa-rss menu-icon" aria-hidden="true"></i>Blogs</a>
					</li>
				</ul>
			</div>
			<!-- /.navbar-collapse -->
		...
		<header id="header" class="header">
			<div class="top-left">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#">Manjeera Trinity Corporate</a>
				...
				<div class="header-menu">
					<div class="header-left">
						...
						<div class="dropdown for-notification">
							...
							<div class="dropdown-menu" id="notificatnMenu" aria-labelledby="notification">
						...
						<div class="dropdown for-message">
							...
							<div class="dropdown-menu" aria-labelledby="message">
								<p class="red">You have 4 Requests</p>
								<a class="dropdown-item media" href="#">
