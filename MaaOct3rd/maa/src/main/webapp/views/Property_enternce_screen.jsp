                                                ...
                                                <div class="card-header user-header alt bg-dark">
                                                    <div class="media">
                                                      ...
                                                      <c:when test='${empty property.prtyimg}'>
                                                        <a href="Dashboard?prptyid=${property.buildingid}">
                                                      <img class="align-self-center rounded-circle mr-3" style="width:85px; height:85px;" alt="" src="resources/maa-images/maa_logo2.jpg">
                                                   </a> 
                                                    </c:when>
                                                      <c:otherwise>
                                                     <a href="Dashboard?prptyid=${property.buildingid}"> <img class="align-self-center rounded-circle mr-3" style="width:85px; height:85px;" alt="" src="resources/maa-images/${property.prtyimg}">
                                                     </a> </c:otherwise>
                                                      </c:choose>
                                                            
                                                        <div class="media-body mt-2">
                                                       
                                                           <a href="Dashboard?prptyid=${property.buildingid}&prptyname=${property.build_name}" style="color:#17a2b8">  <h4 class=" display-6">${property.build_name}</h4>
