									...
									<c:if test='${roleid==1||roleid==2}'>
										<div class="addButton" style="float: right">
											<button type="button" class="btn btn-info btn-sm"
												data-toggle="modal" data-target="#visitorAddModal" id="modalClose">
										...
										<c:forEach var="vlist" items="${visitorList}">
											<tr>
												...
												<c:choose>
												 ...
												 <td><span class="spnDetails">${fn:substring(vlist.purpose, 0, 20)}</span><span class="spnTooltip">${vlist.purpose}</span></td>
												<td>${vlist.intime}</td>
												<td>${vlist.outtime}</td>
				...
				<div class="modal fade" id="visitorAddModal" tabindex="-1"
					...
					<div class="modal-dialog modal-lg" role="document">
						<div class="modal-content">
							<form action="saveVisitorDetails" method="POST" id="addForm">
								<input type="hidden" class="form-control" name="prptyid" id="prptyid_add"
											...
											<div class="card">
												...
												<div class="card-body">
													...
													<div class="form-group row">
														<label class="col-sm-12 col-form-label">Purpose<span style="color:red" >*</span></label>
														<div class="col-sm-12" id="custm-select">
															<input type="text" id="purpose" name="purpose"
																placeholder="Purpose"  class="form-control" pattern="^[ A-Za-z0-9_@./#&,-]*$" maxlength="250" required>
																<span>only 250 characters allowed</span>
														</div>
													</div>

													<div class="form-group">
														<label for="company" class=" form-control-label">InTime<span style="color:red" >*</span></label>
															
															<div class="input-group date" id="datetimepicker1" 
															data-target-input="nearest">
															<input type="text"
																class="form-control datetimepicker-input"
																data-target="#datetimepicker1" name="intime"  required/>
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="card">
												...
												<div class="card-body">
													...
													<div class="form-group row">
														...
														<div class="col-sm-12" id="custm-select">
															<input type="text" id="epurpose" name="epurpose"
																placeholder="Purpose" class="form-control" pattern="^[ A-Za-z0-9_@./#&,-]*$" required>
														</div>
													</div>
													...
													<div class="form-group">
														<label for="company" class="form-control-label">In Time<span style="color:red" >*</span></label>
...
$('#addForm').trigger("reset");
  ...
  $('#visitfor').click(function(){
   ...
   $('#visitfor1').click(function(){
	   var prptyid=$('#prptyid_add').val();
        	   $('#visitfor').prop("checked",false);
            	$('#assetDiv').show();
            	$.ajax({
	      	         type: "GET",
	      	         url: "getAssetsByProperty?prtyid="+prptyid+"",
	      	         cache: false,
	      	         async: false,               
	      	         success: function(response){
	      	        	for (var i = 0; i < response.length; i++) {
							...
							$('#flatno').append(
									'<option value=' + flattext + '>' + flattext+'/'+ownerName
											+ '</option>');
