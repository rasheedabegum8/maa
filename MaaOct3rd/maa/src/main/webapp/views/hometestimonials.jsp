...
<head>
   ...
   <title>maaproperties.com Reviews &ndash; Client Testimonials,Customer Review </title>
  <link href="resources/images/favicon.ico" rel="shortcut icon">
  <meta name="keywords"Client Reviews,Customer Reviews,Client Testimonials,maaproperties.com Reviews,Customer Testimonials,Member Testimonials,Success Story of maaproperties.com,Testimonials of Real Estate Serivices,Real Estate Property Portal Testimonials,Testimonials of Indian Property Portal,maaproperties.com Review">
  <meta name="description" content="Client Reviews and Testimonials - Read our customers testimonials stories, 'how maaproperties.com provide Services to its customer?' and also send your testimonials, we will publish them.">
  <link rel="canonical" href="http://maaproperties.com/testimonials">
<!---Facebook---->
    <meta property="og:site_name" content="maaproperties.com"/>
    <meta property="og:url" content="http://maaproperties.com/testimonials"/>
    <meta property="og:type" content="website" />
    <meta property="og:title" content="maaproperties.com Reviews &ndash; Client Testimonials,Customer Review "/>
    <meta property="og:image" content="http://maaproperties.com/resources/homeimages/testimonials/0012.jpg"/>
    <meta property="og:description" content="Client Reviews and Testimonials - Read our customers testimonials stories, 'how maaproperties.com provide Services to its customer?' and also send your testimonials, we will publish them." />
...
<!---twitter---->
    ...
    <meta name="twitter:title" content="maaproperties.com Reviews &ndash; Client Testimonials,Customer Review">
    <meta name="twitter:description" content="Client Reviews and Testimonials - Read our customers testimonials stories, 'how maaproperties.com provide Services to its customer?' and also send your testimonials, we will publish them.">
    <meta name="twitter:image" content="http://maaproperties.com/resources/homeimages/testimonials/0012.jpg">	
	<!-- Bootstrap CSS -->
	...
	<link rel="stylesheet" href="css/fonts/font-awesome.css" type="text/css">
...
<body>
		...
		<div class="container my-5">
			<div class="row">
				<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
					<div class="service-title my-3">
						<div class="row">
							<div class="col-10">
								<h4>Maa Properties-Reviews</h4>
							</div>
							<!--<div class="col">
					...
					<div class="about-description text-justify">
						<div class="row">
							<div class="col">
								<div class="testimonial-div border p-3">
									<div class="row">
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
											<div class="testimonial-img">
										<img src="resources/homeimages/testimonials/ramakrishna.jpg" class="img-fluid"> <span> Ramakrishna p</span>
									</div>
										</div>
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
										<div class="starts">
									...
									<div class="testimonail-desc pt-2">
										<p>Thank you for the good service. Will definitely be recommending your services to my friends</p>
									</div>
								</div>
								<div class="testimonial-div border p-3 mt-2">
									<div class="row">
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
											<div class="testimonial-img">
										<img src="resources/homeimages/testimonials/0012.jpg" class="img-fluid"> <span> Koteswararao M</span>
									</div>
										</div>
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
										<div class="starts">
									...
									<div class="testimonail-desc pt-2">
										<p>I am young professional, Maa properties search helped me in shortlisting property in Hyderabad. I learned what kind of property will cost me how much and what are the types of amenities I will be getting?</p>
									</div>
								</div>
							</div>
				...
				<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
					<div class="add-image">
						<img src="images/banner/add1.jpg" class="img-fluid">
					</div>
				</div>
			</div>
		</div>
	...
	<!--Share Page icon modal popup start here-->
