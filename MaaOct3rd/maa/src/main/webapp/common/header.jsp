        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand hidden" href="home"><img src="resources/img/logo/rounded_logo.png" alt="Logo"></a>
                </div>
                    ...
                    <div class="user-area dropdown float-right">
                       ...
                       <c:choose>
                        ...
                        <c:when test="${roleid == 3}">
                         <span style="color:white"><b>Owner</b></span>
                        </c:when>
                        <c:when test="${roleid == 4}">
                         <span style="color:white"><b>Tenant</b></span>
                        </c:when>
                        <c:otherwise>
                     	 <span style="color:white"><b>Others</b></span>
                        </c:otherwise>
                        </c:choose> 
                       </a>
