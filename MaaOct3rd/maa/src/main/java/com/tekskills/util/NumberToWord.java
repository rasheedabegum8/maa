...
if(decimal>0 && decimal>=20) {
         paise = (decimal) > 0 ? " And  " + words.get(Integer.valueOf((int) (decimal - decimal % 10))) + " " + words.get(Integer.valueOf((int) (decimal % 10))) : "";
         val =" Paise Only";
}else if(decimal>0 && decimal>=10&&decimal<20) {
	paise = (decimal) > 0 ? " And   " + words.get(Integer.valueOf((int) (decimal))) : "";
	val =" Paise Only";
}else if(decimal==0) {
	paise="";
	val =" Only";
}
return  Rupees + paise + val;
    }
