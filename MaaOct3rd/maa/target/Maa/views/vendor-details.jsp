							...
							<div class="table-responsive">
								<table id="vendorTable" class="text-center table-borderless" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
									...
									<c:forEach var="vendor" items="${vendorList}">
										<tr>
											<td><img class="photo_round" src="resources/maa-images/${vendor.vendorimg}" style="width: 40px;height: 40px;border-radius: 50%;"></td>
								...
								<div class="row">
											...
											<div class="card-body card-block">
												<div class="form-group ">
													...
													<div class="custom-file">
														<input type="file"  id="vendorimg"  name="vendorimg" required>
												...
												<input type="hidden" class="form-control" id="prptyName" name="prptyName" value='${prptyName}'>
													...
													<input type="text" id="vendorname"  name="vendorname" placeholder="Vendor Name" class="form-control" required>
												</div>
												<div class="form-group">
													...
													<select class="custom-select" id="profession"  name="profession" required>
														...
														<option value="3">Driver Services</option>
														...
														<option value="WaterTankerServices">Water Tanker Services</option>
												...
												<div class="form-group">
													...
													<input type="text" id="mobile"  name="mobile" minlength="10" maxlength="12"  pattern="^[0-9]*$" placeholder="Vendor Mobile" class="form-control" required>
												</div>
												<div class="form-group">
													<label for="company" class=" form-control-label">Alternate Mobile Number</label>
													<input type="text" id="altmobile"  name="altmobile" minlength="10" maxlength="12"  pattern="^[0-9]*$" placeholder="Vendor Mobile" class="form-control">
												</div>
												<div class="form-group">
													<label for="company" class=" form-control-label">Email</label>
													<input type="text" id="email"  name="email" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,63}$" placeholder="Vendor Email" class="form-control">
												</div>
												<div class="form-group">
									...
									<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
										<div class="card">
											...
											<div class="card-body card-block">
												<div class="form-group ">
													<label for="company" class=" form-control-label">Upload ID Proof</label>
													<div class="custom-file">
												...
												<div class="form-group">
													...
													<input type="text" id="idno"  name="idno" pattern="^([A-Za-z0-9]+ )+[A-Za-z0-9]+$|^[A-Za-z0-9]+$" placeholder="ID No" class="form-control" required>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<input type="text" id="address"  name="address" pattern="^([A-Za-z0-9]+ )+[A-Za-z0-9]+$|^[A-Za-z0-9]+$" placeholder="Ex:Kukatpally" class="form-control" required>
												</div>
												<div class="form-group">
													<label for="company" class=" form-control-label">Pincode<span style="color:red;">*</span></label>
													<input type="text" id="pincode"  name="pincode" minlength="6" maxlength="8"  pattern="^[0-9]*$" placeholder=" Pincode" class="form-control" required>
												</div>
											...
											<div class="card-body card-block">
												<div class="form-group ">
													...
													<div class="custom-file">
														...
														<span style="color:red;font-size: 14px;" id="vImagefile"></span>
														<!-- <label class="custom-file-label" for="customFileLangHTML" data-browse="Picture" >Upload image</label> -->
													</div>
												</div>
												<div class="form-group">
												<input type="hidden" class="form-control" id="prtyid" name="prtyid" value='${prptyid}'>
												...
												<div class="form-group">
													<label for="company" class=" form-control-label">Valid ID Proof<span style="color:red;">*</span></label>
													<select class="custom-select" id="E_idtype"  name="E_idtype" required>
														<option value="">Valid ID Proof</option>
														<option value="Passport">Passport</option>
											...
											<div class="card-body card-block">
												<div class="form-group ">
													...
													<div class="custom-file">
														...
														<!-- <span id="idprooffile" style="color:red;font-size: 14px;"></span> -->
														<!-- <label class="custom-file-label" for="customFileLangHTML" data-browse="Picture">Upload ID Proof</label> -->
													</div>
												</div>
												<div class="form-group">
													<label for="company" class=" form-control-label">ID No<span style="color:red;">*</span></label>
													<input type="text" id="E_idno"  name="E_idno" placeholder="ID No" class="form-control" required>
												</div>
