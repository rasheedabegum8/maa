                            ...
                            <div class="row">
                              ...
                              <c:if test='${roleid==2||roleid==1}'>
                                    <div class="btnright" style="float: right">
                                        ...
                                        '${property.note}','${property.mgr_name}','${property.mgr_phone}','${property.mgr_alt_phone}',
                                         '${property.mgr_email}','${property.status}','${property.secphn}','${property.secname}','${property.secemail}','${property.buldingmail}')">
                ...
                <div class="col-md-12" id="proprtyAdd">
                 <form action="loadProperty" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body card-block">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="BuildingName" id="BuildingName" placeholder="Building Name" class="form-control" pattern="^([A-Za-z]+ )+[A-Za-z]+$|^[A-Za-z]+$" required>
                                            </div>
                                            <div class="form-group">
                    ...
                    <label for="company" class=" form-control-label" id="inputGroupFileAddon01">Image</label>
                                            ...
                                            <div class="form-group">
                                                <label for="company" class=" form-control-label">Common Water Meter<span style="color:red;">*</span></label>
                                                <input type="text"id="comnWtrMeter" name="comnWtrMeter" minlength="9" maxlength="12" required pattern="^[0-9]*$" placeholder="Common Water Meter" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body card-block">
											...
											<div class="form-group">
                                                ...
                                                <input type="text" name="SecEMail" id="SecEMail" placeholder="Security Email ID" class="form-control" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,63}$">
                                            </div>
                                            <div class="form-group">
                                 ...
                                 <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body card-block">
                                            ...
                                            <div class="form-group">
                                                <label for="company" class=" form-control-label">Common Water Meter <span style="color:red;">*</span></label>
                                                <input type="text" name="iWtrCmnMeter" id="iWtrCmnMeter" placeholder="Common Water Meter" class="form-control" minlength="9" maxlength="12" required pattern="^[0-9]*$" value="${property.watermeterno}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                 <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"> 
                                    <div class="card">
                                        ...
                                        <div class="card-body card-block">
											...
											<div class="form-group">
                                                <label for="company" class=" form-control-label">Security phone No</label>
                                                <input type="text" name="iSecPhn" id="iSecPhn" placeholder="Security phone No" class="form-control" minlength="10" maxlength="12" required pattern="^[0-9]*$" value="${property.secphn}">
                                            </div>
											<div class="form-group">
                                                <label for="company" class=" form-control-label">Security Email ID</label>
   ...
   <script src="https://code.jquery.com/jquery-1.10.2.js"></script>
    <script>
        ...
        function proprtyIdEdit(buildingid,userid,build_name,upiid,
              ...
              ,note,mgr_name,mgr_phone,mgr_alt_phone
