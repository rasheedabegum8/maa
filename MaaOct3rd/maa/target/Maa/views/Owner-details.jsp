									...
									<div class="col-4">
										<div class="addButton" id="ownerPlusAdd" style="float: right">
											<button type="button" class="btn btn-info btn-sm"
												data-toggle="modal" data-target="#ownerAddModal">
								...
								<table id="ownerDetails" class="text-center" data-toggle="table"
									...
									<tbody>
										<c:forEach var="ownr" items="${onwerList}">
											...
											'${ownr.address}','${ownr.email}','${ownr.contact}','${ownr.altcontact}','${ownr.note}','${ownr.status}','${ownr.flat}','${ownr.pic}','${ownr.id_pic}')">
														<i class="fa fa-eye"></i>
											...
											'${ownr.address}','${ownr.email}','${ownr.contact}','${ownr.altcontact}','${ownr.note}','${ownr.status}','${ownr.prtyid}','${ownr.pic}','${ownr.id_pic}','${ownr.flat}')">
												...
												<div class="row mx-auto">
													...
													<div class="col-lg-6 col-md-8 col-sm-6 col-xs-6">
														<p>
															...
															<i class="fa fa-phone"></i>&nbsp;<span id="saltphn"></span>
														</p>
														<p>
															<b>UPID:</b><span id="supiid"></span><br> <b>Notes:</b><span
																id="snotes"></span><br> <span id="saddress"></span><br>
															<b>Units:</b> <span id="sunit"></span>
														</p>
														<p>
														...
														<div class="profilePic mt-4">
															<div class="tab-content" id="pills-tabContent">
																...
																<div class="tab-pane fade" id="pills-houseImg"
																	...
																	<div class="owner-image text-center">
																		<img id='ownerImageIdp' class="img-fluid">
																	</div>
																</div>
															</div>
												...
												<div class="card-body card-block">
													<div class="form-group">
														...
														<input type="text" id="Name" name="Name" 
															placeholder="Name" class="form-control" pattern="^([A-Za-z]+ )+[A-Za-z]+$|^[A-Za-z]+$" required>
													</div>
													<div class="row">
														...
														<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
															<div class="form-group">
																...
																<div class="custom-file">
																	<input type="file" 
																		id="ownrIdImg" name="ownrIdImg" required> <!-- label
																		class="custom-file-label" for="customFileLangHTML"
																		data-browse="ID">Upload image(Required) </label>-->
																</div>
															</div>
														</div>
													</div>
													...
													<div class="form-group">
														<label for="company" class=" form-control-label">UPID
															Number</label> <input type="text" id="UPID" name="UPID"
															placeholder="UPID Number" class="form-control">
													</div>
												...
												<div class="card-body">
													<div class="form-group">
														<label for="company" class=" form-control-label">Mobile
															...
															placeholder="Mobile number" class="form-control" minlength="10" maxlength="12"  pattern="^[0-9]*$" required>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<input type="text" id="Address" name="Address"
															placeholder="Address" class="form-control" pattern="^([A-Za-z]+ )+[A-Za-z0-9]+$|^[A-Za-z]+$" required>
													</div>
													<div class="form-group">
													...
													<div class="row">
														...
														<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
															<div class="form-group">
																...
																<div class="custom-file">
																	<input type="file" 
																		id="IownrIdImg" name="IownrIdImg"><!--  <span
																		id="IspownrIdImg"></span> <label
																		class="custom-file-label" for="customFileLangHTML"
																		data-browse="ID">Upload image(Required)</label> -->
																</div>
															</div>
						...
						success : function(response) {
							...
							for (var i = 0; i < response.length; i++) {
								...
								var tr = "<tr><td><input type='checkbox' id='IchkBox"+response[i].assetid+"' name='IchkBox'></td>"
										...
										+ response[i].flatno
										+ "</td>"
										+ " <td><select class='form-control' id='Iocc_by"+response[i].assetid+"' name='Iocc_by'><option value=''>occupant By</option> <option value='O'>Owner</option><option value='V'>Vacant</option></select></td></tr>";
