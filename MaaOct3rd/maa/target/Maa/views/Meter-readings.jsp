																			...
																			<tbody>
																				<tr>
																					...
																					<td><input type="text" id="wpresent"
																						name="wpresent" pattern="^[0-9.]*$" required class="form-control">
																					</td>
																					<td><input type="text" id="wCost"
																						name="wCost" required class="form-control" value="${cost.wtrCost}" readonly></td>
																				</tr>
																			</tbody>
																		</table>
																			...
																			<tbody>
																				<tr>
																					<td><input type="text" id="Cpresent"
																						name="Cpresent" pattern="^[0-9.]*$" required class="form-control"></td>
																			...
																			<tbody>
																				<tr>
																					...
																					<td><input type="text" id="Gpresent"
																						name="Gpresent" pattern="^[0-9.]*$"required class="form-control"></td>
																		...
																		<tbody>
																			<tr>
																				...
																				<td><input type="text" id="Dpresent"
																					name="Dpresent" pattern="^[0-9.]*$" required class="form-control"></td>
																		...
																		<tbody>
																			<tr>
																				...
																				<td><input type="text" id="ACpresent"
																					name="ACpresent"  pattern="^[0-9.]*$" required class="form-control"></td>
																				
																				<td><input type="text" id="ACcost"
																					name="ACcost" required class="form-control" value="${cost.acCost}" readonly></td>
																			</tr>
																		</tbody>
																	</table>
																</div>
																		...
																		<tbody>
																			<tr>
																				...
																				<td><input type="text" id="Otpresent"
																					name="Otpresent" pattern="^[0-9.]*$" required class="form-control"></td>
																				
																				<td><input type="text" id="Otcost"
																					name="Otcost" required class="form-control" value="${cost.otherCost}" readonly></td>
																			</tr>
																		</tbody>
																	</table>
																</div>
															...
															<div class="card-body">
																...
																<div class="form-group">
																	...
																	<div class="row">
																		...
																		<div class="col-2">
																			<button type="button" class="btn btn-info mb-1"
																				data-toggle="modal" data-target="#meterEditIndModal">
																				<i class="fa fa-search"></i>
																			</button>
																		</div>
																		<div class="col"></div>
																	</div>
																	<div class="modal fade" id="meterEditIndModal"
																		tabindex="-1" role="dialog"
																		aria-labelledby="largeModalLabel" aria-hidden="true">
																					...
																					<div class="form-group">
																						<div class="form-check-inline form-check">
																							...
																							<label for="inline-radio2"
																								...
																								class="form-check-input">Only Assets
																							</label>
																						</div>
																					</div>
																					<table id="editmeterInner" class="text-center"
																						data-toggle="table" data-pagination="true"
																						data-search="true" data-show-columns="true"
																						data-show-pagination-switch="true"
																						data-show-refresh="true" data-key-events="true"
																	...
																	<table class="table text-center">
																		...
																		<tbody>
																			<tr>
																				...
																				<td><input type="text" id="e_wmr" name="e_wmr" class="form-control" ></td>
																...
																<div class="card-body">
																	<table class="table text-center">
																		...
																		<tbody>
																			...
																			<tr>
																				<td><input type="text" id="e_pmr" name="e_pmr" class="form-control"></td>
																...
																<div class="card-body">
																	<table class="table text-center">
																		...
																		<tbody>
																			...
																			<tr>
																				<td><input type="text" id="e_gmr" name="e_gmr" class="form-control"></td>
															...
															<div class="card" id="meterCard">
																...
																<div class="card-body">
																	<table class="table text-center">
																		...
																		<tbody>
																			<tr>
																				<td><input type="text" id="e_dmr" name="e_dmr" class="form-control"></td>
															...
															<div class="card" id="meterCard">
																...
																<div class="card-body">
																	<table class="table text-center">
																		...
																		<tbody>
																			<tr>
																				<td><input type="text" id="e_amr" name="e_amr" class="form-control"></td>
															...
															<div class="card" id="meterCard">
																...
																<div class="card-body">
																	<table class="table text-center">
																		...
																		<tbody>
																			<tr>
																				<td><input type="text" id="e_omr" name="e_omr" class="form-control"></td>
...
function submitReadins(){
	...
	arra1.push(Others);
	 if(arra1.includes(true)&&unitNo!=""){
		...
		$("#inlineBulkCheckbox1").click(function() {
			$(".waterBulkMeter").toggle();
			$(".currentBulkMeter").toggle();
			$(".disselBulkMeter").toggle();
			$(".gasBulkMeter").toggle();
			$(".acBulkMeter").toggle();
			$(".OtherBulkMeter").toggle();
		});
		$(".currentBulkMeter").hide();
		$("#inlineBulkCheckbox2").click(function() {
			$(".currentBulkMeter").toggle();
		});
		$(".disselBulkMeter").hide();
		$("#inlineBulkCheckbox3").click(function() {
			$(".disselBulkMeter").toggle();
		});

		$(".waterBulkMeter").hide();
		$("#inlineBulkCheckbox4").click(function() {
			$(".waterBulkMeter").toggle();
		});
		$(".gasBulkMeter").hide();
		$("#inlineBulkCheckbox5").click(function() {
			$(".gasBulkMeter").toggle();
		});
		$(".acBulkMeter").hide();
		$("#inlineBulkCheckbox6").click(function() {
			$(".acBulkMeter").toggle();
		});
		$(".OtherBulkMeter").hide();
		$("#inlineBulkCheckbox7").click(function() {
			$(".OtherBulkMeter").toggle();
		});
	</script>
...
if( wmr!=0 && pmr!=0 && dmr!=0 && gmr!=0 && amr!=0 && omr!=0 ){
	...
	function deleteReadings(flat,prtyid,month,year,tblpk){
		 ...
		 $.ajax({
  	         type: "post",
  	         url: "DeleteReadingsByFlat?flat="+flat+"&prtyid="+prtyid+"&month="+month+"&year="+year+"&tblpk="+tblpk+"",
  	         cache: false,
  	         async: false,               
  	         success: function(response){
