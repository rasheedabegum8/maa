										...
										<div class="card">
											...
											<div class="form-check-inline form-check">
												...
												<div class="input-group date" id="datetimepicker1" data-target-input="nearest" >
													<input type="text" class="form-control datetimepicker-input" data-target="#datetimepicker1"  name="intime" placeholder="In time" />
												...
												<!-- <div class="form-group">
													<label for="company" class=" form-control-label">In
														Time</label> <input type="text" id="datetimepicker1" name="intime" placeholder="In time"
														class="form-control">
												</div> -->
												<div class="form-group">
