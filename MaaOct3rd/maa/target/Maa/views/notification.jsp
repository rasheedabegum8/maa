                            ...
                            <div class="row">
                                ...
                                <c:if test='${roleid==2||roleid==1}'>
                                    <div class="addButton" id="NotificatinPlusAdd" style="float: right">
                                        <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#notificationAddModal">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body card-block">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="title" name="title" pattern="^[ A-Za-z0-9_@./#&+-]*$" placeholder="Title" class="form-control">
                                            </div>
                                            <div class="form-group"> 
                                                <label for="company" class=" form-control-label">Date</label>
                                                <input type="date" id="notfDate" name="notfDate" placeholder="Title" class="form-control">
                                            </div>
                                ...
                                <div class="col mx-auto">
                                    <div class="card">
                                        ...
                                        <div class="card-body card-block">
                                            ...
                                            <div class="form-group"> 
                                                <label for="company" class=" form-control-label">Date</label>
                                                <input type="date" id="edate" name="edate" placeholder="Title" class="form-control">
                                            </div>
